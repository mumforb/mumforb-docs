# Mongo Database Class Methods

For reference, this is a copy/paste of everything that printed from calling `db.help()` inside `mongosh` while connected to a DB (v7.0.5):
